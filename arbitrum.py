...
addresses = pd.read_csv(r"D:\code\allocations.csv")['address'].tolist()
...
df_related_addresses.to_csv(r"D:\code\arbitrum_related_address_pairs.csv", index=False)

print("Related address pairs on Optimism have been saved to arbitrum_related_address_pairs.csv.")
