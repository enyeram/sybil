...
groups_df = pd.read_csv(r"D:\code\gnosis_large_connected_groups.csv")
...
for index, group in enumerate(groups, start=1):
    ...
    for address in addresses:
        transactions = get_transactions_gnosis(address, API_KEYS_GNOSIS[0])
...
# save
output_file_path = r"D:\code\gnosis_token_transfers_per_group.csv"
