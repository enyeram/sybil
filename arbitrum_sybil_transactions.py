...
groups_df = pd.read_csv(r"D:\code\arbitrum_large_connected_groups.csv")
...
for index, group in enumerate(groups, start=1):
    ...
    for address in addresses:
        transactions = get_transactions_arbitrum(address, API_KEYS_ARBITRUM[0])
...
# save
output_file_path = r"D:\code\arbitrum_token_transfers_per_group.csv"
