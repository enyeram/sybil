...
df_related_addresses.to_csv(r"D:\code\gnosis_related_address_pairs.csv", index=False)

print("Related address pairs on Optimism have been saved to gnosis_related_address_pairs.csv.")
